...
class MedicineDetailViewModelTests {
    ...
    func resetState() {
        ...
        mockService.shouldThrowObserveHistoryError = false
        viewModel.medicines = []
        viewModel.history = []
    ...
    @Test
    func testObserveHistorySuccess() async throws {
        // Given
        resetState()
    ...
    @Test
    func testObserveHistoryFailure() async throws {
        // Given
        resetState()
        let medicine = Medicine(id: "medicineID1", name: "Aspirin", stock: 50, aisle: "A1")
        mockService.shouldThrowObserveHistoryError = true
